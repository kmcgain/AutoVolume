...
public class MainActivity extends Activity {
    ...
    private Runnable checkVolume = new Runnable() {
    	...
    	public void run() {			
    		if (record != null) {
      		...
      		checkVolumeHandler.postDelayed(checkVolume, 100);
    	}
    };
    ...
    public void lowThresholdChange(View view) {
    	int progress = ((SeekBar)findViewById(R.id.seekBarLowThreshold)).getProgress();
    	((EditText)findViewById(R.id.lowThresholdValue)).setText("" + progress);
    }
    
    public void highThresholdChange(View view) {
    	int progress = ((SeekBar)findViewById(R.id.seekBarHighThreshold)).getProgress();
    	((EditText)findViewById(R.id.highThresholdValue)).setText("" + progress);
    }
